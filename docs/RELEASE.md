...
committed and annotated tag `v2.2.3-port.5` points to that commit. The script
...
- `dist/create-deep-seas-forge-1.20.1-2.2.3-port.5.jar` — normal production JAR.
- `release/2.2.3-port.5/` — production/sources JARs, exact tracked-source ZIP,
